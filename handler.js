...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '[ ⚠ ] دعوه - للجروب', body: 'Sasuke-Bot', thumbnail: imagen1, sourceUrl: 'https://chat.whatsapp.com/KxmMvxsBpS5HBvucOo6Fin'}}}}, aa);
