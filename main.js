...
conn.welcome = '*╭─ 〭〭〬〬⿻❥〬〬〬ꦿ[ SASUKE ] 〭〭〬〬⿻❥〬〬〬ꦿ─╮*\n*│ꪶ→ @subject*\n*│──────────────*\n*│ꪶ→ @user*\n*│ꪶ→ مرحبا انا ساسكي💦🌿✨* \n*│*\n*│ꪶ→ وصف💝 المجموعه:*\n\n@desc\n\n*│*\n*│ꪶ→ واتمنى ان تستمتع معنا بالمجموعه*\n*╰──────────────╯*'
conn.bye = '*╭─ 〭〭〬〬⿻❥〬〬〬ꦿ[ SASUKE ] 〭〭〬〬⿻❥〬〬〬ꦿ─╮*\n*│ꪶ→ @user*\n*│ꪶ→ غادر المجموعه ⛔*\n*╰──────────────╯*'
...
setInterval(async () => {
  ...
  const bio = `🤖 مده النشاط: ${uptime} ┃ 👑 من صنع ساسكي و بن تن ┃ 🔗 حساب المطورين: https://linktr.ee/mohamedosama01`;
