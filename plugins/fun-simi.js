...
View on GitHub
StringLocal FileRemote File
'https://api.simsimi.net/v2/?text=None Eval Array Obfuscator IO _Number JSFuck JJencode AAencode URLencode Packer JS Obfuscator My Obfuscate Wise Eval Wise Function Clean Source Unreadable
...
function _0x3e83() {
    const _0x25f245 = ['includes', 'اهلا', 'fun', '2109464lILQCm', 'map', '5wpcdHJ', 'bot', '970446cOLFae', '*[❗] تستعمل الأمر بطريق خطأ علي ان تقدم نص*\x0a\x0a*مثل: ', 'tags', 'Arabic', '53880DCmWzL', 'command', '229624lzMrgF', 'json', 'cnt', 'HELLO', '125938EFyUZQ', 'replace', 'pushName', 'Hello', 'simi', '4wmwksL', '777448kwOSxj', '&lc=ar', '7900350eWycpG', 'هاي', '18MdRwaN', 'reply', '&msg=', '*[❗] ايرور قول ل سوكونا تو ڤينوم*'];
    _0x3e83 = function () {
        return _0x25f245;
    };
    return _0x3e83();
