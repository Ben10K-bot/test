...
handler.before = async _0x134797 => {
  ...
  if (_0x1c0499.simi) {
    ...
    try {
      ...
      const _0x38137a = await _0x3f611b("http://api.brainshop.ai/get?bid=153868&key=rcKonOgrUFmn5usX&uid=" + _0x1d373d + "&msg=" + _0x2b1f77[0x0][0x0][0x0]);
      ...
      await _0x134797.reply(_0x323531[0x0][0x0][0x0]);
    }
    return true;
  }
  return true;
