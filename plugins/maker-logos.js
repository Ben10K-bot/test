import _0x3263be from "axios";
import _0x5e96f9 from "cheerio";
import _0x3707fe from "form-data";
const handler = async (_0x51f738, {
  conn: _0x19f86b,
  args: [_0x10b200],
  text: _0x197856,
  usedPrefix: _0x198ae1,
  command: _0x544cf6,
  name: _0x246c22
}) => {
  if (!_0x10b200) {
    throw "*[📎 تنبيه 📎] اخـتـار اسـم مـن اللي مـوجـوديـن لاكن الامـر بالانـجـلـيزي فقط\n*علي سبـيل المثال:*\n—◉ _.لوجو Wolf-Logo-Galaxy VENOM_\n\n*<عندك كتير  وكل مختلف/>*\n\n❒┋🍀⟫ .لوجو\n Ben10|Sasuke " + effects.map(_0x510a60 => _0x510a60.title).join("\n*❒┋🍀⟫ .لوجو* ");
  }
  if (!effects.find(_0x437ba5 => new RegExp(_0x437ba5.title, "gi").test(_0x10b200))) {
    throw "*[❗𝐈𝐍𝐅𝐎❗] 𝙴𝙻 𝙴𝙵𝙴𝙲𝚃𝙾 " + _0x10b200 + " 𝙽𝙾 𝙴𝚂𝚃𝙰 𝙴𝙽 𝙻𝙰 𝙻𝙸𝚂𝚃𝙰 𝙳𝙴 𝙴𝙵𝙴𝙲𝚃𝙾𝚂*";
  }
  let _0x28d057 = _0x197856.replace(new RegExp(_0x10b200, "gi"), '').trimStart();
  if (_0x28d057.includes("|")) {
    _0x28d057 = _0x28d057.split("|").map(_0x25a3b3 => _0x25a3b3.trim());
  } else {
    _0x28d057 = [_0x28d057.trim()];
  }
  const _0xa1e59 = effects.find(_0x59d4ee => new RegExp(_0x59d4ee?.["title"], "i").test(_0x10b200));
  const _0x3c79e3 = await maker(_0xa1e59?.["url"], [..._0x28d057])["catch"](_0x78132e => {
    throw "*[❗] عذرا لاكن لا استطيع تنفيذ الأمر حاول ان تكتب الأمر بشكل اوضح*";
  });
  if (typeof _0x3c79e3 == "number") {
    throw _0x3c79e3 == -0x1 ? "*[❗𝐈𝐍𝐅𝐎❗] 𝙴𝙻 𝙴𝙵𝙴𝙲𝚃𝙾 " + _0x10b200 + " 𝙽𝙾 𝙴𝚂𝚃𝙰 𝙴𝙽 𝙻𝙰 𝙻𝙸𝚂𝚃𝙰 𝙳𝙴 𝙴𝙵𝙴𝙲𝚃𝙾𝚂*" : "*[❗𝐈𝐍𝐅𝐎❗] 𝙴𝙻 𝚄𝚂𝙾 𝙲𝙾𝚁𝚁𝙴𝙲𝚃𝙾 𝙳𝙴𝙻 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝙴𝚂 " + (_0x198ae1 + _0x544cf6) + " " + _0x10b200 + " " +x new Array(_0x3c79e3).fill("texto").map((_0x39941f, _0x4fa72a) => _0x39941f + (_0x4fa72a ? _0x4fa72a + 0x1 : '')).join("|") + "*";
  }
  await _0x19f86b.sendMessage(_0x51f738.chat, {
    "image": {
      "url": _0x3c79e3.image
    },
    "caption": "*تم تنفيذ العملية ✔️!!*\n*الطلب: " + _0x10b200 + "*"
  }, {
    "quoted": _0x51f738
  });
};
...
async function maker(_0x4c9025, _0x35b65c) {
  if (/https?:\/\/(ephoto360|photooxy|textpro)\/\.(com|me)/i.test(_0x4c9025)) {
    throw new Error("URL Invalid");
  }
  try {
    let _0x537825 = await _0x3263be.get(_0x4c9025, {
      "headers": {
        "Accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7",
        "Origin": new URL(_0x4c9025).origin,
        "Referer": _0x4c9025,
        "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.0.0 Safari/537.36 Edg/115.0.1901.188"
      }
    });
    let _0x12b0ad = _0x5e96f9.load(_0x537825.data);
    let _0x5a83ef = _0x12b0ad("#build_server").val();
    let _0x430092 = _0x12b0ad("#build_server_id").val();
    let _0x4ae9eb = _0x12b0ad("#token").val();
    let _0x59abe4 = _0x12b0ad("#submit").val();
    let _0x1d53dd = [];
    _0x12b0ad("input[name=\"radio0[radio]\"]").each((_0x4f6c27, _0x3fce66) => {
      _0x1d53dd.push(_0x12b0ad(_0x3fce66).attr("value"));
    });
    let _0x326ecc;
    if (_0x1d53dd.length != 0x0) {
      _0x326ecc = {
        "radio0[radio]": _0x1d53dd[Math.floor(Math.random() * _0x1d53dd.length)],
        "submit": _0x59abe4,
        "token": _0x4ae9eb,
        "build_server": _0x5a83ef,
        "build_server_id": Number(_0x430092)
      };
    } else {
      _0x326ecc = {
        "submit": _0x59abe4,
    ...
    let _0x4226bf = new _0x3707fe();
    for (let _0x5ba200 in _0x326ecc) {
      _0x4226bf.append(_0x5ba200, _0x326ecc[_0x5ba200]);
    }
    if (typeof _0x35b65c == "string") {
      _0x35b65c = [_0x35b65c];
    }
    for (let _0x614ceb of _0x35b65c) _0x4226bf.append("text[]", _0x614ceb);
    let _0x4e2680 = await _0x3263be.post(_0x4c9025, _0x4226bf, {
      "headers": {
        "Accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7",
        "Origin": new URL(_0x4c9025).origin,
        "Referer": _0x4c9025,
        "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.0.0 Safari/537.36 Edg/115.0.1901.188",
        "Cookie": _0x537825.headers.get("set-cookie").join("; "),
        ..._0x4226bf.getHeaders()
      }
    });
    _0x12b0ad = _0x5e96f9.load(_0x4e2680.data);
    let _0x2f9fd3 = _0x12b0ad("#form_value").first().text() || _0x12b0ad("#form_value_input").first().text() || _0x12b0ad("#form_value").first().val() || _0x12b0ad("#form_value_input").first().val();
    let _0x50cbcd = await _0x3263be.post(new URL(_0x4c9025).origin + "/effect/create-image", JSON.parse(_0x2f9fd3), {
      "headers": {
        "Accept": "*/*",
    ...
    return {
      "status": _0x50cbcd.data?.["success"],
      "image": _0x5a83ef + (_0x50cbcd.data?.["fullsize_image"] || _0x50cbcd.data?.["image"] || ''),
      "session": _0x50cbcd.data?.["session_id"]
    };
  } catch (_0x4464c6) {
    throw _0x4464c6;
  }
