...
function _0xd63f() {
    const _0x13198c = ['vnd.openxmlformats-officedocument.presentationml.presentation', 'vnd.openxmlformats-officedocument.spreadsheetml.sheet', 'application/', '\x0a╠═〘 _معلومات البوت_ 〙 ═\x0a╠\x0a╠➥ [🤴🏻] المصممين: *Ben10 - Sasuke*\x0a╠➥ [#️⃣] الارقام: *+966547540321* او *+201205987431*\x0a╠➥ [🎳] البادئه;: *', 'floor', '\x0a╠➥ [👨‍🦯] السرعه: \x0a╠  *', '*\x0a╠➥ [🎩] المستخدمين: *', 'pdf', 'user', '\x0a╠➥ [📵] مضاد المكالمات: ', 'toString', '250011WlPnkk', 'entries', 'memoryUsage', 'chat', '*مفعل*', 'length', 'https://chat.whatsapp.com/DmGUnUroeRB1FAoBnHZMWP', '1403015HVUDKR', 'isChats', '*عام*', '\x0a╠➥ [❗] التقيد: ', '*\x0a╠➥ [🦜] الجروبات: *', 'info', '539328kiyuoI', 'ᴇʟ ᴍᴇᴊᴏʀ ʙᴏᴛ ᴅᴇ ᴡʜᴀᴛsᴀᴘᴘ', 'data', 'users', 'zip', 'command', ' \x0a╠➥ [💬] خاص فقط: ', '36696ziHOau', 'vnd.openxmlformats-officedocument.wordprocessingml.document', ' ms* \x0a╠\x0a╠═〘 Ben 10 - Sasuke Bot 〙 ═\x0a', 'settings', '@g.us', 'trim', '\x0a╠➥ [🏢] جروبات فقط: ', 'help', '*\x0a╠➥ [🔐] شات الخاص: *', 'sendMessage', '3466281EgUznn', '*خاص*', 'map', '* \x0a╠➥ [💡] عدد المحادثات: *', 'tags', 'filter', '\x0a╠➥ [💬] مضاد الخاص: ', 'now', 'endsWith', '159788KEWCNi', '689064HQaqIv', '* \x0a╠➥ [🚀] النشاط: *', '*غير مفعل*', 'random', 'jid', 'join', '「  𝑯𝒆𝒍𝒍𝒐 𝑾𝒐𝒓𝒍𝒅 」', 'padStart'];
    _0xd63f = function () {
        return _0x13198c;
    };
    return _0xd63f();
